...
class PDEmodel:
    ...
    def fit(self, error='mse'):
        ...
        optimisation = differential_evolution(self.costfn, bounds=self.bounds, args=(self.initial_condition, self.functiondata),maxiter=10000, popsize=50) #differential_evolution
